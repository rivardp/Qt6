...
bool GLOBALVARS::createAllOutputFiles(QDate &today)
{
    ...
    root = QString("RBconnectionError");
    ...
    root = QString("LegacyAuditListing");
...
void GLOBALVARS::cleanUp()
{
        FHrunTimeError->deleteLater();
        FHrecordError->deleteLater();
        FHurlError->deleteLater();
        FHconnectionError->deleteLater();
        FHsqlError->deleteLater();
        FHactionRequired->deleteLater();
//        FHrunSummary->deleteLater();
//        FHauditListing->deleteLater();
}
