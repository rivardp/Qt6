...
bool GLOBALVARS::createAllOutputFiles(QDate &today)
{
    ...
    root = QString("CheckMonitoredrunTimeError");
    ...
    root = QString("CheckMonitorederrorRecord");
    ...
    root = QString("CheckMonitoredurlError");
    ...
    root = QString("CheckMonitoredconnectionError");
    ...
    root = QString("CheckMonitoredsqlError");
    ...
    root = QString("CheckMonitoredactionRequired");
    ...
    root = QString("CheckMonitoredrunSummary");
    ...
    root = QString("CheckMonitoredauditListing");
...
void GLOBALVARS::logMsg(msgType messageType, QString msg, int msgInfo)
{
    ...
    case RunSummary:
        ...
        *outputStream << "CheckMonitored stat: " << msg << Qt::endl;
        FHrunSummary->close();
        break;
