...
bool GLOBALVARS::createAllOutputFiles(QDate &today)
{
    ...
    root = QString("CheckforInactiveFHrunTimeError");
    ...
    root = QString("CheckforInactiveRecordError");
    ...
    root = QString("CheckforInactiveFHconnectionError");
    ...
    root = QString("CheckforInactiveFHsqlError");
    ...
    root = QString("CheckforInactiveFHactionRequired");
    ...
    root = QString("CheckforInactiveFHrunSummary");
    ...
    root = QString("CheckforInactiveFHauditListing");
...
void GLOBALVARS::logMsg(msgType messageType, QString msg, int msgInfo)
{
    ...
    case RunSummary:
        ...
        *outputStream << "CheckforInactiveFH stat: " << msg << Qt::endl;
        FHrunSummary->close();
        break;
