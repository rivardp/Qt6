...
bool OQString::removeLeadingNeeEtAl(LANGUAGE language)
{
    ...
    QStringList wordList = remainingString.split(QString(" "), QString::SkipEmptyParts, Qt::CaseInsensitive);
    if (wordList.size() >= 3)
    {
...
void OQString::compressCompoundNames(const LANGUAGE lang)
{
    ...
    while (end < last)
    {
        ...
        else
        {
            ...
            if (end < last)
            {
                // Need to obtain next word for aboriginal check
                int tempEnd = itsString.indexOf(space, start, Qt::CaseInsensitive);
                if (tempEnd == -1)
                    tempEnd = last;
                nextWord = itsString.mid(start, tempEnd - start);
                nextWord.removeBookEnds(PARENTHESES | QUOTES, true);
                nextWord.removeLeading(PARENTHESES | QUOTES);

                if (!(isCompound || cleanWord.isAboriginalName(nextWord)))
                    result += space;
            }
        }
    }
...
void OQString::fixBasicErrors(bool onlyContainsNames)
{
    ...
    itsString.replace(QLatin1String(" ï¿½ "), "-", Qt::CaseInsensitive);

    target.setPattern("([A-Z]|[a-z])nï¿½e");
    itsString.replace(target, "\\1ée");

    target.setPattern(" ï¿½(\\w+)ï¿½");
    itsString.replace(target, " \"\\1\"");

    // Replace problematic chars
    itsString.replace(QLatin1String("œ"), "oe", Qt::CaseInsensitive);
    target.setPattern("\\b1/2\\b");
    itsString.replace(target, "");

    // Remove all "RR #" references
    target.setPattern(" RR [0-9]+");
    itsString.replace(target, " ");

    // Remove problematic degrees
    target.setPattern("\\,? Ph\\.?\\s?D\\.?,?\\b");
    itsString.replace(target, " ");
    target.setPattern("\\,? O\\.?\\s?C\\.?,?\\b");
    itsString.replace(target, " ");

    // Remove the leading "le" from all French dates
    target.setPattern("le ([0-9]{2} )");
    itsString.replace(target, " \\1");

    // Replace January 1, 1983 to June 8, 2020 to hyphenated
    target.setPattern("(, [0-9]{4} )(to)( [A-Z])");
    itsString.replace(target, "\\1-\\3");

    // Fix malformed ordinals and then remove all
    target.setPattern("(\\d) (st|nd|rd|th)( |,)");
    itsString.replace(target, "\\1 ");
    target.setPattern("(\\d) (ième|ieme|ière|iere)( |,)");
    itsString.replace(target, "\\1 ");
    target.setPattern("(\\d) (st|nd|rd|th)");
    itsString.replace(target, "\\1 ");
    target.setPattern("(\\d) (ième|ieme|ière|iere)");
    ...
    itsString.replace(QString("Sunday"), QString(""), Qt::CaseInsensitive);
    itsString.replace(QString("Monday"), QString(""), Qt::CaseInsensitive);
    itsString.replace(QString("Tuesday"), QString(""), Qt::CaseInsensitive);
    itsString.replace(QString("Wednesday"), QString(""), Qt::CaseInsensitive);
    itsString.replace(QString("Thursday"), QString(""), Qt::CaseInsensitive);
    itsString.replace(QString("Friday"), QString(""), Qt::CaseInsensitive);
    itsString.replace(QString("Saturday"), QString(""), Qt::CaseInsensitive);
    itsString.replace(QString("dimanche"), QString(""), Qt::CaseInsensitive);
    itsString.replace(QString("lundi"), QString(""), Qt::CaseInsensitive);
    itsString.replace(QString("mardi"), QString(""), Qt::CaseInsensitive);
    itsString.replace(QString("mecredi"), QString(""), Qt::CaseInsensitive);
    itsString.replace(QString("jeudi"), QString(""), Qt::CaseInsensitive);
    itsString.replace(QString("vendredi"), QString(""), Qt::CaseInsensitive);
    itsString.replace(QString("samedi"), QString(""), Qt::CaseInsensitive);

    // Ensure all french dates are lower case
    target.setPattern(QLatin1String("\\b(Janvier|Fevrier|Février|Mars|Avril|Mai|Juin|Juillet|Aout|Août|Septembre|Octobre|Novembre|Decembre|Décembre)\\b"));
    ...
    // Fix malformed dates
    target.setPattern("\\b(January|February|March|April|May|June|July|August|September|October|November|December) (\\d\\d?)\\.\\s?([1-2][0|9][0-9][0-9])\\b");  // period instead of comma
    itsString.replace(target, "\\1 \\2, \\3");
    target.setPattern("\\b(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Sept|Oct|Nov|Dec) (\\d\\d?)\\.\\s?([1-2][0|9][0-9][0-9])\\b");  // period instead of comma
    itsString.replace(target, "\\1 \\2, \\3");
    target.setPattern("\\.( \\d\\d?, [1-2][0|9][0-9][0-9])"); // Extra period of month
    itsString.replace(target, "\\1");
    target.setPattern("( \\d\\d?,)([1-2][0|9][0-9][0-9])"); // Missing space
    itsString.replace(target, "\\1 \\2");
    target.setPattern("(, [1-2][0|9][0-9][0-9])(\\S)"); // Missing space #2
    itsString.replace(target, "\\1 \\2");
    target.setPattern("(A-Z|a-z)(January|February|March|April|May|June|July|August|September|October|November|December) (\\d\\d?)\\,\\s?([1-2][0|9][0-9][0-9])");  // Missing space #3
    itsString.replace(target, "\\1 \\2 \\3, \\4");
    target.setPattern("(A-Z|a-z)(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Sept|Oct|Nov|Dec) (\\d\\d?)\\,\\s?([1-2][0|9][0-9][0-9])");  // Missing space #4
    itsString.replace(target, "\\1 \\2 \\3 \\4");
    target.setPattern(" (\\d\\d?)\\. ([1-2][0|9][0-9][0-9])"); // Period instead of comma
    itsString.replace(target, " \\1, \\2");
    target.setPattern("(\\d) of (Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Sept|Oct|Nov|Dec)");
    itsString.replace(target, "\\1 \\2");
    target.setPattern(QLatin1String("(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Sept|Oct|Nov|Dec|jan|janv|fév|févr|mar|avr|juil|sept|oct|nov|déc)\\.(\\d)"));
    itsString.replace(target, "\\1. \\2");
    target.setPattern("(January|February|March|April|May|June|July|August|September|October|November|December)(\\d)");
    itsString.replace(target, "\\1 \\2");
    target.setPattern("([1-2][0|9][0-9][0-9])-(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Sept|Oct|Nov|Dec)");
    itsString.replace(target, "\\1 - \\2");
    target.setPattern("([1-2][0|9][0-9][0-9]) -(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Sept|Oct|Nov|Dec)");
    itsString.replace(target, "\\1 - \\2");
    target.setPattern("([1-2][0|9][0-9][0-9])- (Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Sept||Oct|Nov|Dec)");
    ...
    target.setPattern("(\\d\\d?)\\s?(January|February|March|April|May|June|July|August|September|October|November|December)\\s?([1-2][0|9][0-9][0-9])");
    itsString.replace(target, "\\2 \\1, \\3");
    target.setPattern("(\\d\\d?)\\s?(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Sept|Oct|Nov|Dec)\\s?([1-2][0|9][0-9][0-9])");
    itsString.replace(target, "\\2 \\1, \\3");

    // Fix malformed french dates
    target.setPattern(QLatin1String("(janvier|fevrier|février|mars|avril|mai|juin|juillet|aout|août|septembre|octobre|novembre|decembre|décembre),?\\s+?(\\d{4})"));
    itsString.replace(target, "\\1 \\2");
    target.setPattern(QLatin1String("(\\s+\\d+)(janvier|fevrier|février|mars|avril|mai|juin|juillet|aout|août|septembre|octobre|novembre|decembre|décembre)"));
    itsString.replace(target, "\\1 \\2");
    target.setPattern(QLatin1String("(\\s+\\d+)(jan|janv|fév|févr|mar|avr|juil|sep|sept|oct|nov|déc)"));
    itsString.replace(target, "\\1 \\2");
    target.setPattern(QLatin1String("(janvier|fevrier|février|mars|avril|mai|juin|juillet|aout|août|septembre|octobre|novembre|decembre|décembre) (\\d\\d?),? (\\d{4})"));
    itsString.replace(target, "\\2 \\1 \\3");

    // Fix abbreviated yy dates
    target.setPattern("\\b(January|February|March|April|May|June|July|August|September|October|November|December) (\\d\\d?)/(0|1|2)(\\d)\\b");
    itsString.replace(target, "\\1 \\2, 20\\3\\4");
    target.setPattern("\\b(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec) (\\d\\d?)/(0|1|2)(\\d)\\b");
    itsString.replace(target, "\\1 \\2, 20\\3\\4");
    target.setPattern("\\b(janvier|fevrier|février|mars|avril|mai|juin|juillet|aout|août|septembre|octobre|novembre|decembre|décembre) (\\d\\d?)/(0|1|2)(\\d)\\b");
    itsString.replace(target, "\\1 \\2, 20\\3\\4");
    target.setPattern("\\b(jan|janv|fév|févr|mars|avr|mai|juin|juil|août|sep|sept|oct|nov|déc) (\\d\\d?)/(0|1|2)(\\d)\\b");
    itsString.replace(target, "\\1 \\2, 20\\3\\4");
    target.setPattern("\\b(January|February|March|April|May|June|July|August|September|October|November|December) (\\d\\d?)/(\\d\\d)\\b");
    itsString.replace(target, "\\1 \\2, 19\\3");
    target.setPattern("\\b(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec) (\\d\\d?)/(\\d\\d)\\b");
    itsString.replace(target, "\\1 \\2, 19\\3");
    target.setPattern("\\b(janvier|fevrier|février|mars|avril|mai|juin|juillet|aout|août|septembre|octobre|novembre|decembre|décembre) (\\d\\d?)/(\\d\\d)\\b");
    itsString.replace(target, "\\1 \\2, 19\\3");
    target.setPattern("\\b(jan|janv|fév|févr|mars|avr|mai|juin|juil|août|sep|sept|oct|nov|déc) (\\d\\d?)/(\\d\\d)\\b");
    itsString.replace(target, "\\1 \\2, 19\\3");

    // Standardize french dates and strip out the "le"
    target.setPattern(QLatin1String("(\\b[Ll]e\\s+)?(\\d+ )(janvier|fevrier|février|mars|avril|mai|juin|juillet|aout|août|septembre|octobre|novembre|decembre|décembre),? (\\d{4})"));
    itsString.replace(target, "\\2\\3 \\4");
    ...
    itsString.replace(target, "(\\1 \\2 - \\3 \\4)");
    target.setPattern("(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Sept|Oct|Nov|Dec) (\\d+, \\d{4}) - (Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Sept|Oct|Nov|Dec) (\\d+, \\d{4})");
    itsString.replace(target, "(\\1 \\2 - \\3 \\4)");
    target.setPattern(QLatin1String("(\\d+ janvier|fevrier|février|mars|avril|mai|juin|juillet|aout|août|septembre|octobre|novembre|decembre|décembre) (\\d{4}) - (\\d+ janvier|fevrier|février|mars|avril|mai|juin|juillet|aout|août|septembre|octobre|novembre|decembre|décembre) (\\d{4})"));
    itsString.replace(target, "(\\1 \\2 - \\3 \\4)");
    target.setPattern(QLatin1String("(\\d+ jan|janv|fév|févr|mars|avr|mai|juin|juil|août|sep|sept|oct|nov|déc) (\\d{4}) - (\\d+ jan|janv|fév|févr|mars|avr|mai|juin|juil|août|sep|sept|oct|nov|déc) (\\d{4})"));
    itsString.replace(target, "(\\1 \\2 - \\3 \\4)");
    itsString.replace("((", "(");
    itsString.replace("))", ")");

    // Flip reversed written dates
    target.setPattern("(\\d{4}) (January|February|March|April|May|June|July|August|September|October|November|December) (\\d\\d?) - (\\d{4}) (January|February|March|April|May|June|July|August|September|October|November|December) (\\d\\d?)");
    itsString.replace(target, "(\\2 \\3, \\1 - \\5 \\6, \\4)");
    target.setPattern("(\\d{4}) (Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Sept|Oct|Nov|Dec) (\\d\\d?) - (\\d{4}) (Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Sept|Oct|Nov|Dec) (\\d\\d?)");
    itsString.replace(target, "(\\2 \\3, \\1 - \\5 \\6, \\4)");

    // Strip out locations within DOB locationA - DOD locationB
    target.setPattern("(January|February|March|April|May|June|July|August|September|October|November|December) (\\d+, \\d{4})(\\s*-?\\s*\\b[A-Z]\\w{1,15},? [^a-z0-9]\\w{0,15}\\s*)(January|February|March|April|May|June|July|August|September|October|November|December) (\\d+, \\d{4})(\\s*-?\\s*\\w{1,15},? \\w{0,15}\\s*)");
    itsString.replace(target, "(\\1 \\2 - \\4 \\5) ");
    target.setPattern("(January|February|March|April|May|June|July|August|September|October|November|December) (\\d+, \\d{4})(January|February|March|April|May|June|July|August|September|October|November|December) (\\d+, \\d{4})(\\s*-?\\s*\\w{1,15},? \\w{0,15}\\s*)");
    itsString.replace(target, "(\\1 \\2 - \\3 \\4) ");
    target.setPattern("(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Sept|Oct|Nov|Dec) (\\d+, \\d{4})(\\s*-?\\s*\\w{1,15},? \\w{0,15}\\s*)(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Sept|Oct|Nov|Dec) (\\d+, \\d{4})(\\s*-?\\s*\\w{1,15},? \\w{0,15}\\s*)");
    itsString.replace(target, "(\\1 \\2 - \\4 \\5) ");
    target.setPattern("(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Sept|Oct|Nov|Dec) (\\d+, \\d{4})(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Sept|Oct|Nov|Dec) (\\d+, \\d{4})(\\s*-?\\s*\\w{1,15},? \\w{0,15}\\s*)");
    itsString.replace(target, "(\\1 \\2 - \\3 \\4) ");
    ...
    target.setPattern(" -([1-9])"); // No space in front of number
    itsString.replace(target, " - \\1");
    target.setPattern("([0-9])- "); // No space after number
    itsString.replace(target, "\\1 - ");

    // Fix missing spaces
    target.setPattern("\\s+(\\d+)(year|an)s");
    itsString.replace(target, " \\1 \\2s");
    target.setPattern("\\s+de(\\d+)\\s+");
    itsString.replace(target, " de \\1 ");

    // Remove space in "O' Hara"
    target.setPattern("O' ([A-Z])");
    itsString.replace(target, "O'\\1");
    target.setPattern("O\" ([A-Z])");
    itsString.replace(target, "O'\\1");
    target.setPattern("O\"([A-Z])");
    itsString.replace(target, "O'\\1");

    // Remove space in "Mc Donald"
    target.setPattern("\\b(M[A|a]?[C|c]) ([A-Z])");
    itsString.replace(target, "\\1\\2");
    /*target.setPattern("Mc ([A-Z])");
    itsString.replace(target, "Mc\\1");
    target.setPattern("Mac ([A-Z])");
    itsString.replace(target, "Mac\\1");*/

    // Remove hyphen in "pre-deceased"
    target.setPattern("([P]|[p])re-([D]|[d])eceased");
    itsString.replace(target, "\\1redeceased");
    ...
    itsString.replace(QLatin1String("bien-aimée "), QString(""), Qt::CaseInsensitive);
    itsString.replace(QLatin1String("bien aimée "), QString(""), Qt::CaseInsensitive);
    itsString.replace(QLatin1String("bien-aimé "), QString(""), Qt::CaseInsensitive);
    itsString.replace(QLatin1String("bien aimé "), QString(""), Qt::CaseInsensitive);
    itsString.replace(QLatin1String("adorée "), QString(""), Qt::CaseInsensitive);
    ...
    target.setPattern("(\\b\\d\\d? years) and \\d\\d? months?");
    itsString.replace(target, "\\1");
    target.setPattern("(\\b\\d\\d? ans) et \\d\\d? mois");
    itsString.replace(target, "\\1");
    ...
    target.setPattern("( de )(M|m)(onsieur|adame|ademoiselle|me|lle)?(\\.? )");
    itsString.replace(target,"\\1");

    // Fix problematic English word combinations
    target.setPattern("([M|m]emorial) ([A-Z]|[a-z])");
    itsString.replace(target, "\\1\\2");
    ...
    itsString.replace(QLatin1String("décès de "), QLatin1String("décès "), Qt::CaseInsensitive);
    ...
    itsString.replace(QLatin1String("beau-frère"), QLatin1String("beauffrrère"), Qt::CaseInsensitive);
    itsString.replace(QLatin1String("beaux-frère"), QLatin1String("beauffrrère"), Qt::CaseInsensitive);

    // Remove problematic French words
    target.setPattern("([Ss]ecteur\\s+\\w+\\s?)");
    itsString.replace(target, "");
    itsString.replace(QLatin1String("commémoration"), "", Qt::CaseInsensitive);

    // Fix French grammatical challenges
    target.setPattern("d'(A|E|I|O|U|H])");
    itsString.replace(target, "de \\1");
    target.setPattern("l'(A|E|I|O|U|H])");
    itsString.replace(target, "les \\1");
    /*itsString.replace(QLatin1String("mère d'"), QLatin1String("mère de "), Qt::CaseSensitive);
    itsString.replace(QLatin1String("père d'"), QLatin1String("père de "), Qt::CaseSensitive);
    ...
    itsString.replace(QLatin1String("épouse d'"), QLatin1String("épouse de "), Qt::CaseSensitive);
    itsString.replace(QLatin1String("époux d'"), QLatin1String("époux de "), Qt::CaseSensitive);*/

    // Replace "œ" with "oe"
    itsString.replace(QChar(339), QString("oe"), Qt::CaseInsensitive);

    // Remove unnecessary colons starting a list - needed for truncation based on key words
    ...
    itsString.replace(QString("~"), QString("-"));
    itsString.replace(QChar(173), QString(" "));
    ...
    // Remove all French days of the week
    itsString.replace(QString("dimanche "), QString(""));
    itsString.replace(QString("lundi "), QString(""));
    itsString.replace(QString("mardi "), QString(""));
    itsString.replace(QString("mercredi "), QString(""));
    itsString.replace(QString("jeudi "), QString(""));
    itsString.replace(QString("vendredi "), QString(""));
    itsString.replace(QString("samedi "), QString(""));
    ...
    target.setPattern("\\b(S[t|T])([e|E]?)(\\.?)[ |-]([A-Z])");
    //target.setPattern("\\b(S[t|T][e|E]?)[\\.|-]?\\s?([A-Z])");
    itsString.replace(target, "\\1\\2.\\4");
    /*target.setPattern("\bSt ([A-Z])");
    itsString.replace(target, "St\\.\\1");
    target.setPattern("\bSte ([A-Z])");
    itsString.replace(target, "Ste\\.\\1");
    target.setPattern("\bSte-([A-Z])");
    itsString.replace(target, "Ste\\.\\1");*/
    ...
    {
        target.setPattern("-St\\. ([A-Z])");
        itsString.replace(target, "-St.\\1");
        target.setPattern("-Ste\\. ([A-Z])");
        itsString.replace(target, "-Ste.\\1");
    }
    ...
    if (!onlyContainsNames)
    {
        target.setPattern("([a-z]|[0-9])\\.[A-Z]");
        int i= -1;
        while (-1 != (i = itsString.indexOf(target, i+1)))
...
bool OQString::checkQuotes(unsigned int numQuotes)
{
    ...
    //QRegExp rx("/[\"'][\w\s]+[\"']|\w+[\"']\w+/");
    //QRegExp rx("[\"' ]?([^\"' ]*)[\"' ]");
    QRegExp anyQuoteVariation("(\\x0022|\\x0027|\\x0060|\\x009[1-4])");
    QRegExp openingQuoteVariations("([ (]\\x0022|[ (]\\x0027|[ (]\\x0060|[ (]\\x009[1-4])");
    QRegExp closingQuoteVariations("(\\x0022[ )]|\\x0027[ )]|\\x0060[ )]|\\x009[1-4][ )])");
...
QList<monthInfo> OQString::monthsFrenchFull = QList<monthInfo> ()
    ...
    << monthInfo(QLatin1String("février"), 2 )
    << monthInfo(QLatin1String("août"), 8 )
    << monthInfo(QLatin1String("décembre"), 12 );

QList<monthInfo> OQString::monthsFrenchAbbreviated = QList<monthInfo> ()
        << monthInfo("jan", 1 )
        << monthInfo("janv", 1 )
        << monthInfo(QLatin1String("fév"), 2 )
        << monthInfo(QLatin1String("févr"), 2 )
        << monthInfo("mar", 3 )
        << monthInfo("avr", 4 )
        << monthInfo("juil", 7 )
        << monthInfo("sep", 9 )
        ...
        << monthInfo("oct", 10 )
        << monthInfo("nov", 11 )
        << monthInfo(QLatin1String("déc"), 12 );
...
QList<dayOfWeekInfo> OQString::daysOfWeekSpanish = QList<dayOfWeekInfo> ()
    ...
    << dayOfWeekInfo(QString(QLatin1String("miércoles")), 4 )
    << dayOfWeekInfo("jueves", 5 )
    << dayOfWeekInfo("viernes", 6 )
    << dayOfWeekInfo(QString(QLatin1String("sábado")), 7 )
    << dayOfWeekInfo("miercoles", 4 )
    << dayOfWeekInfo("sabado", 7 );

QList<QString> OQString::provAbbreviations      = QList<QString> () << "ab" << "bc" << "mb" << "nb" << "nf" << "nl" << "ns" << "on" << "pei" << "qc" << "sk";
QList<QString> OQString::otherAbbreviations      = QList<QString> () << "fr" << "mt" << "sts";

QList<QString> OQString::aboriginalNames = QList<QString> () << "alone" << "bad" << "bear" << "bears" << "big" << "bird" << "black" << "bone" << "bow" << "bruised" << "bull"
                                                             ...
                                                             << "panther" << "peigan" << "pine" << "plume" << "quills" << "red" << "rider" << "robe" << "runner" << "running"
                                                             << "shoes" << "shots" << "sitting" << "sky" << "skies" << "small" << "smoke" << "speaker" << "spear" << "spotted" << "squirrel"
...
QList<QString> OQString::altNameIndicators  = QList<QString> () << "aka" << "born" << "dit" << "dite" << "formerly" << "nee"
                                                                << QString(QLatin1String("neé")) << QString(QLatin1String("née"));
QList<QString> OQString::changedContextIndicators = QList<QString> () << "attended" << "battling" << "came" << "emigrated" << "grade" << "graduated" << "immigrated" << "married" << "moved" << "moving" << "returned"
                                                                      << "served" << "settled" << "spent" << "until" << "worked";
...
QList<QString> OQString::genderWordsSpanishM = QList<QString> () << "el" << "su" << QString(QLatin1String("él"));
...
QList<QString> OQString::femaleTitlesFrench    = QList<QString> () << "madame" << "mademoiselle" << "mlle" << "mme";
...
QList<QString> OQString::neeEtAlwords    = QList<QString> () << "born" << "formerly" << "maiden" << "n" << "nee"
                                                             << QString(QLatin1String("neé")) << QString(QLatin1String("né")) << QString(QLatin1String("née")) << QString(QLatin1String("nèe"));
QList<QString> OQString::ordinalsEnglish = QList<QString> () << "st" << "nd" << "rd" << "th";
QList<QString> OQString::ordinalsFrench  = QList<QString> () << "ieme" << "iere"  << QString(QLatin1String("ième")) << QString(QLatin1String("ière"));
QList<QString> OQString::ordinalsSpanish = QList<QString> () << "a" << "er";

QList<QString> OQString::precedingIndicators = QList<QString> () << "before attaining" << "before her" << "before his" << "during her" << "during his" << "in her" << "in his" << "prior to" << "short of" << "shy of";

QList<QString> OQString::prefixesAbbreviatedEnglish = QList<QString> () << "adm" << "arch" << "bish" << "br"
                                                                        << "capt" << "cdr" << "cdt" << "cfp" << "cmdr" << "col" << "cpl" << "cst" << "cwo"
                                                                        << "dc" << "dr" << "flt" << "fr" << "frcs" << "gen" << "gov"
                                                                        << "hon" << "lcol" << "llb" << "lt"
                                                                        << "maj" << "mcpl" << "msgr" << "mwa" << "ofm" << "omm" << "prof" << "pvt"
                                                                        << "raf" << "rcaf" << "rcmp" << "rcn" << "rep"  << "rev" << "rjm" << "rn" << "rsr" << "rt" << "rtd"
                                                                        << "sasv" << "scsl" << "sen" << "sgt" << "sj" << "ssccjm";
...
QList<QString> OQString::prefixesFullEnglish = QList<QString> () << "admiral" << "archbishop" << "baby" << "bishop" << "brother"
                                                                 << "cadet" << "canon" << "captain" << "commander" << "colonel" << "constable" << "corporal"
                                                                 << "deacon" << "doctor" << "father" << "flt" << "general" << "governor"
                                                                 << "honorable" << "honourable" << "justice" << "lieutenant"
                                                                 << "major" << "master" << "monsignor" << "pastor" << "private" << "professor"
                                                                 << "retired" << "reverend" << "right"
                                                                 << "sargent" << "senator" <<  "sister" << "the";
QList<QString> OQString::prefixesFullFrench  = QList<QString> () << QString(QLatin1String("abbé")) << QString(QLatin1String("frère")) << "l'abbe" << QString(QLatin1String("l'abbé"))
                                                                 << "l'honorable" << "monsieur" << QString(QLatin1String("père")) << "soeur" << "sœur";
...
QList<QString> OQString::suffixesDropEnglish    = QList<QString> () << "ba" << "bcomm" << "bed" << "bmsc"
                                                                    << "bs" << "bsc" << "bscn" << "bve" << "bvoced"
                                                                    << "ca" << "cd" <<  "cfc" << "cm" << "cma" << "csb" << "csc" << "csj" << "cssr"
                                                                    << "dds" << "dip" << "doctor" << "dsm" << "dvm" << "eng" << "esq"
                                                                    << "facs" << "fca" <<  "fcia" << "fcscj" << "fj" << "fr" << "frcp" << "frcpc" << "frcsc" << "fsa" << "gm"
                                                                    << "honors" << "honours" << "ing" << "juris" << "kstj"
                                                                    << "lld" << "llb" << "ma" << "md" << "med" << "ndsc" << "obgyn" << "ocad" << "olm" << "omi" << "osb"
                                                                    <<  "pc" << "peng" << "phd"
                                                                    << "qc" << "rcmp" << "ret" << "ret'd" << "retd" << "rev" << "rn" << "rndm" << "sdb" << "sgm" << "ssmi"
                                                                    << "ue" << "wwi" << "wwii";
QList<QString> OQString::suffixesDropFrench     = QList<QString> () << "testtest";
...
QList<QString> OQString::uncapitalizedNames  = QList<QString> () << "cinq" << "da" << "dalla" << "das" << "de" << "del" << "dela" << "den" << "der" << "des"
                                                                 << "di" << "do" << "dos" << "du" << QString(QLatin1String("dè")) << "e" << "el"
...
QList<QString> OQString::ignoreWordsEnglish3 = QList<QString> () << "age" << "all" << "and" << "are" << "but" << "cow" << "dad" << "due" << "for"
                                                                 ...
                                                                 << "the" << "was" << "way" << "who" << "you";
QList<QString> OQString::ignoreWordsEnglish4 = QList<QString> () << "aged" << "also" << "away" << "best" << "born" << "care" << "dada" << "dadi" << "dear" << "deep" << "died" << "down" << "from" << "gift"
                                                                 << "have" << "held" << "here" << "high" << "home" << "into" << "late" << "left" << "life" << "lock" << "lost"
                                                                 << "made" << "many" << "miss" << "nana" << "nani" << "near" << "once" << "ones" << "papa"
                                                                 << "rest" << "safe" << "sale" << "side" << "that" << "they" << "this" << "urne"
                                                                 << "wall" << "went" << "when" << "wife" << "with" << "year" << "your";
QList<QString> OQString::ignoreWordsEnglish5 = QList<QString> () << "after" << "began" << "civil" << "covid" << "death" << "ended" << "first" << "grand" << "great" << "happy" << "honey"
...
QList<QString> OQString::ignoreWordsEnglish6 = QList<QString> () << "access" << "active" << "adored" << "always" << "angels" << "auntie" << "badger" << "battle" << "better" << "behind" << "broken" << "burial"
                                                                 << "candle" << "caring" << "chapel" << "christ" << "dearly" << "divine" << "doting" << "during" << "earned" << "easter"
...
QList<QString> OQString::ignoreWordsEnglish7 = QList<QString> () << "adoring" << "beloved" << "brother" << "crossed" << "details" << "devoted" << "drifted"
                                                                 ...
                                                                 << "journey" << "outlaws" << "passing" << "prayers" << "private" << "retired" << "sadness" << "servant" << "service" << "special"
...
QList<QString> OQString::ignoreWordsEnglish8 = QList<QString> () << "although" << "announce" << "ceremony" << "children" << "daughter" << "deceased" << "departed" << "donation"
                                                                 << "formerly" << "hospital"
                                                                 << "lovingly" << "measures" << "memorial" << "memoriam" << "monument" << "obituary" << "password" << "peaceful" << "precious"
                                                                 << "rejoined" << "resident" << "response" << "reunited" << "saturday" << "silently" << "suddenly" << "survived"
                                                                 << "thursday" << "together" << "tomorrow" << "visiting";
QList<QString> OQString::ignoreWordsEnglish9 = QList<QString> () << "announces" << "beautiful" << "christmas" << "cremation" << "departure" << "donations" << "everybody" << "following"
                                                                 << "heartfelt" << "interment" << "inurnment" << "long-time" << "professor"
                                                                 << "relatives" << "wednesday" ;
QList<QString> OQString::ignoreWordsEnglish10 = QList<QString> () << "celebrated" << "courageous" << "graciously" << "internment" << "originally" << "peacefully"
...
QList<QString> OQString::ignoreWordsFrench1 = QList<QString> () << QString(QLatin1String("à"));
QList<QString> OQString::ignoreWordsFrench2 = QList<QString> () << "au" << QString(QLatin1String("dû")) << "en" << "et" << "le" << "ou" << "tu" << "un";
...
QList<QString> OQString::ignoreWordsFrench5 = QList<QString> () << "achat" << "ainsi" << QString(QLatin1String("année")) << QString(QLatin1String("c'est")) << "cette" << "deuil" << "messe" << "notre" << "oncle" << "outre" << "salon"
                                                                << "selon" << "tante" << "toute" << "votre" << QString(QLatin1String("épouse")) << QString(QLatin1String("époux")) << QString(QLatin1String("étant"));
QList<QString> OQString::ignoreWordsFrench6 = QList<QString> () << "compte" << "grande" << "toutes" << QString(QLatin1String("église"));
QList<QString> OQString::ignoreWordsFrench7 = QList<QString> () << QString(QLatin1String("c'était")) << QString(QLatin1String("détails")) << "famille";
QList<QString> OQString::ignoreWordsFrench8 = QList<QString> () << "complexe" << "souvenir" << "toujours" << "veuillez";
QList<QString> OQString::ignoreWordsFrench9 = QList<QString> () << QString(QLatin1String("l'hôpital")) << "tristesse";
QList<QString> OQString::ignoreWordsFrench10 = QList<QString> () << QString(QLatin1String("prédécédée")) << "subitement";
QList<QString> OQString::ignoreWordsFrench11 = QList<QString> () << QString(QLatin1String("considérant"));
QList<QString> OQString::ignoreWordsFrench12 = QList<QString> () << QString(QLatin1String("condoléances")) << QString(QLatin1String("conformément"));
QList<QString> OQString::ignoreWordsFrench13 = QList<QString> () << "veuillez-vous";
QList<QString> OQString::ignoreWordsFrench14 = QList<QString> () << "internationxxx";
...
QList<QString> OQString::ignoreFirstWords3 = QList<QString> () << "any" << "box" << "due" << "est" << "get" << "god" << "how" << "ils" << "i'd" << "i'm" << "let" << "mum" << "n.e" << "n.w" << "not" << "now" << "one"
                                                               << "rip" << "s.e" << "s.w" << "see" << "she" << "sun" << "tel" << "til" << "two" << QString(QLatin1String("tél")) << "web" << "yet";
...
QList<QString> OQString::ignoreFirstWords5 = QList<QString> () << "above" << "again" << "aloha" << "along" << "among" << QString(QLatin1String("après")) << "ashes" << "aside" << "aunty" << "being"
                                                               << "cease" << "creek" << "don't" << "dream" << "email" << "enjoy" << "enter" << "every" << "femme" << "fille" << "filles"
...
QList<QString> OQString::ignoreFirstWords6 = QList<QString> () << "adjust" << "anyone" << "asleep" << "before" << "beside" << "beyond" << "called" << "cancer" << "casual" << "centre" << "chapel" << "cheers" << "church" << "clergy" << "deeply"
                                                               << "except" << "floral" << "fondly" << "gently" << "guests" << "having" << "heures" << "highly" << "hiking" << "membre" << "people" << "photos" << "prayer" << "public"
                                                               << "rather" << "repose" << QString(QLatin1String("réseau")) << "salons" << "should" << "suivra" << "taking" << "things" << "though" << "uncles" << "within"
                                                               << QString(QLatin1String("épouse")) << QString(QLatin1String("époux"));
QList<QString> OQString::ignoreFirstWords7 = QList<QString> () << "adopted" << "against" << "another" << "baptist" << "because" << "besides" << "between" << "blessed" << "chappel" << "cheques" << "contact" << "cousins" << "dearest" << "deepest" << "despite"
                                                               ...
                                                               << "service" << "shortly" << "sincere" << "singing" << "summers" << "sunrise" << "viewing" << "website" << "whether";
...
QList<QString> OQString::ignoreFirstWords9 = QList<QString> () << "according" << "afternoon" << "attention" << "cherished" << "countless" << "cremation" << "customers" << "dedicated" << "diagnosed" << "direction" << "donations" << "extremely"
                                                               << "gathering" << "graveside" << "honouring" << "initially" << "placement" << "published" << "reception" << QString(QLatin1String("résidence")) << "returning" << "surviving" << "sustained"
                                                               << "telephone" << "therefore" << "undaunted";
...
QList<QString> OQString::relationshipWordsFrenchM  = QList<QString> () << "mari de "
                                                                       << "fils de "
                                                                       << "pere de "
                                                                       << QString(QLatin1String("père de "))
                                                                       << QString(QLatin1String("époux de"))
                                                                       << QString(QLatin1String("précédé par "))
                                                                       << QString(QLatin1String("prédécédé par "));
QList<QString> OQString::relationshipWordsFrenchF  = QList<QString> () << "mere de "
                                                                       << QString(QLatin1String("mère de "))
                                                                       << "femme de "
                                                                       << "fille de "
                                                                       << QString(QLatin1String("épouse de "))
                                                                       << QString(QLatin1String("précédée par "))
                                                                       << QString(QLatin1String("prédécédée par "));
QList<QString> OQString::relationshipWordsFrenchU  = QList<QString> () << "laisse dans le deuil" << "restent pour pleurer" << QString(QLatin1String("époux de"));
...
QList<QString> OQString::ageWordsFrench    = QList<QString> () << "age" << "an" << "anniversaire" << "ans" << "l'age" << QString(QLatin1String("l'âge")) << QString(QLatin1String("âge"));
...
QList<QString> OQString::birthWordsFrench  = QList<QString> () << "nee" << QString(QLatin1String("né")) << QString(QLatin1String("née"));
...
QList<QString> OQString::deathWordsEnglish = QList<QString> () << "age" << "announce" << "breath" << "called" << "crossed" << "death" << "departed" << "departure" << "died"
                                                               ...
                                                               << "went";
QList<QString> OQString::deathWordsFrench  = QList<QString> () << QString(QLatin1String("allé")) << QString(QLatin1String("allée")) << QString(QLatin1String("décès")) << QString(QLatin1String("décès")) << QString(QLatin1String("décédé"))
                                                               << QString(QLatin1String("décédée")) << QString(QLatin1String("départ")) << QString(QLatin1String("éteint")) << QString(QLatin1String("éteinte"))
                                                               << "mort" << "morte" << QString(QLatin1String("quitté")) << QString(QLatin1String("quittée")) << QString(QLatin1String("quittés")) << "rejoindre" << "souffle";
QList<QString> OQString::deathWordsSpanish = QList<QString> () << QString(QLatin1String("falleció")) << QString(QLatin1String("murió"));

QList<QString> OQString::serviceWordsEnglish    = QList<QString> () << "celebration" << "funeral" << "memorial" << "service" << "visitation";
QList<QString> OQString::serviceWordsFrench     = QList<QString> () << "celebration" << QString(QLatin1String("célébration")) << "funeraille" << QString(QLatin1String("funéraille")) << "messe" << "service";
...
QList<QString> OQString::otherMiscKeeperWordsFrench      = QList<QString> () << "de"
                                                                             << "fils"
                                                                             << "fille"
                                                                             << QString(QLatin1String("époux"))
                                                                             << QString(QLatin1String("épouse"));
...
QList<QString> OQString::parentWordsFrenchU  = QList<QString> () << "ses parents" << "enfant de " << QString(QLatin1String("son père"));
...
QList<QString> OQString::brotherWordsFrench  = QList<QString> () << "frere" << QString(QLatin1String("frère"));
...
QList<QString> OQString::childReferencesFrenchM     = QList<QString> () << QString(QLatin1String("père à ")) << QString(QLatin1String("père de ")) << QString(QLatin1String("papa à ")) << "papa de ";
QList<QString> OQString::childReferencesFrenchF     = QList<QString> () << QString(QLatin1String("mère à ")) << QString(QLatin1String("mère de ")) << QString(QLatin1String("maman à ")) << "maman de ";
QList<QString> OQString::childReferencesFrenchU     = QList<QString> () << "sa fille " << "son fils " << "ses filles" << "ses fils" << "son enfant " << "ses enfants" << QString(QLatin1String("son garçon")) << QString(QLatin1String("ses garçons"));
...
QList<QString> OQString::siblingReferencesEnglishM   = QList<QString> () << "brother of " << "brother to " << "his sister " << "his brother " << "brother-in-law of ";
QList<QString> OQString::siblingReferencesEnglishF   = QList<QString> () << "sister of " << "sister to " << "her sister " << "her brother " << "sister-in-law of ";
...
QList<QString> OQString::siblingReferencesFrenchM    = QList<QString> () << QString(QLatin1String("frère de ")) << QString(QLatin1String("frère à "));
QList<QString> OQString::siblingReferencesFrenchF    = QList<QString> () << QString(QLatin1String("soeur de ")) << QString(QLatin1String("soeur à "));
QList<QString> OQString::siblingReferencesFrenchU    = QList<QString> () << "sa soeur " << "ses soeurs " << QString(QLatin1String("son frère ")) << QString(QLatin1String("ses frères "));
...
QList<QString> OQString::spousalReferencesFrenchM   = QList<QString> () << "sa femme " << QString(QLatin1String("l'époux de ")) << "conjoint de";
QList<QString> OQString::spousalReferencesFrenchF   = QList<QString> () << "son mari " << QString(QLatin1String("l'épouse de ")) << "conjointe de";
QList<QString> OQString::spousalReferencesFrenchU   = QList<QString> () << QString(QLatin1String("son épouse ")) << QString(QLatin1String("épouse de ")) << "son conjoint " << "son partenaire " << "sa partenaire ";
...
QList<QString> OQString::relativeReferencesFrench   = QList<QString> () << QString(QLatin1String("nièce ")) << "neveu " << QString(QLatin1String("nièce; ")) << "neveu; " << QString(QLatin1String("nièce: ")) << "neveu:" ;
...
QList<QString> OQString::passingReferencesFrenchM     = QList<QString> () << QString(QLatin1String("décédé "));
QList<QString> OQString::passingReferencesFrenchF     = QList<QString> () << QString(QLatin1String("décédée "));
QList<QString> OQString::passingReferencesFrenchU     = QList<QString> () << QString(QLatin1String("décès "));
