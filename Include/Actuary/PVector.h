// PVector.h - Renamed from PVector.h to remove ambiguity with std::PVector class

//							October 12, 2007 - Added 'add' and 'del' methods and 'removeDuplicates' methods
...
//					   3.6  Returned implementations back to header
//                     4.0  November 16, 2019 - Moved over to Qt
