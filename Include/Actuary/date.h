// date.h     Version 1.0     March 24, 2003
//			          1.1     August 5, 2007 - Added date(0) contructor for Array<> initialization
//                    1.1     October 25, 2007 - Added export() method
//					  1.2     ???
//					  1.3     February 16, 2009 - Added clear() method
//							                    - Set all values to 0 on error
//					  1.4     Februrary 23, 2009 - Add output as string method	
//					  1.5     February 28, 2009 - Eliminate all SHORTs
//					  1.6     October 28, 2014 - Fixes to run VSE 2013 - replace export() with xport()
//                    1.7     January 26, 2016 - Modified StringOutput to work with bitwise operators
//					  1.8     April 22, 2016 - Added isValid() and != operator
//                    2.0     November 16, 2019 - Move to Qt
...
protected:
    ...
    void validateOption(const unsigned int &option, errorFlag &Error);
...
public:
    ...
    date roundUp(const date &d1, const unsigned int &option, errorFlag &Error);
