//	FileDirUtilities.cpp
//
//#include "stdafx.h"
#include "FileDirUtilities.h"

bool FileExists(const PString &filename)
{
...
bool DirectoryExists(const PString &directory)
{
	LPCTSTR szDir = directory.getString();
...
int GetLastVersion(const PString &filename, PString &nextVersion, int numExist)
{
