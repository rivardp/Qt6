...
#ifndef UNQUOTEHTML_H
#define UNQUOTEHTML_H
...
std::wstring unQuoteHTML(std::wstring &input);				// Wrapper around UnquoteHTML
std::wstring removeHTMLtags(std::wstring &input);			// Eliminates all HTML tags (everything in <>)
QString removeHTMLtags(QString &input);			// Eliminates all HTML tags (everything in <>)
std::wstring extractFirstContentBlock(std::wstring &input);	// Extract first block of information not included within HTML tags
